    ...
    return (
        <div className="w-full bg-background-base flex flex-col items-center gap-8 py-4 px-4">
            <div className="w-full flex flex-wrap justify-between items-center gap-4 py-2">
                ...
                <p className="text-foreground-base">La mise à jour des plannings sur le site et le backoffice peut prendre jusqu'à 60s, raffraichir la page pour voir la mise à jour.</p>
                <p className="text-foreground-base">Important : exporter les plannings au format .svg et mettre la couleur d'arrière plan (pour que ce soit assortit au site):</p>
